...
namespace BehaviorDesigner.Runtime.Tactical.Tasks
{
    ...
    public abstract class TacticalGroup : Action
    {
        ...
        private Vector3 SurroundTraget(Vector3 targetPosition)
        {
            ...
            //}
            //Debug.Log($"Unit {tacticalAgent.transform.name }, Move to target new {destination} , orginal {tacticalAgent.TargetTransform.position} , tacticalAgent radius {tacticalAgent.Radius()} , offset {offset} , enemy count {targetByOther}"); 
            return destination;
        }
    }
