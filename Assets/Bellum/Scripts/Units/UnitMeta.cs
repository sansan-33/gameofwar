...
public class UnitMeta
{
    ...
    public static Dictionary<UnitType, int> UnitSelfDestory = new Dictionary<UnitType, int>() { { UnitType.WALL, 20 }, { UnitType.TOWER, 30 }, { UnitType.CATAPULT, 20 }, { UnitType.BARRACK, 30 }, { UnitType.TRAP, 100 } };
