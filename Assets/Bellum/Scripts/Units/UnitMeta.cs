...
public class UnitMeta
{
    ...
    public enum UnitKey { ARCHER, KNIGHT, MAGE, CAVALRY, SPEARMAN, HERO, PRINCE, MINISKELETON, GIANT, KING,
        ...
        ELFRANGER, ELFCAVALRY, ELFFOOTMAN, ELFMAGE, ELFGOLEM, ELFTREEANT, ELFDEMONHUNTER, ELFPRINCE, ELFWALL, UNDEADQUEEN, ELFQUEEN, MULAN,
    ...
    public enum UnitType { ARCHER, TANK, MAGIC, CAVALRY, FOOTMAN, SIEGE, WALL, TOWER, BARRACK, CATAPULT, HERO, KING, ALL, DOOR, TRAP, QUEEN, BEACON, STUPIDTAPIR };
    ...
    public static Dictionary<UnitType, int> UnitSize = new Dictionary<UnitType, int>() { { UnitType.FOOTMAN, 8 }, { UnitType.ARCHER, 2 } };
