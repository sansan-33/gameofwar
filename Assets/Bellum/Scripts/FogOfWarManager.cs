...
public class FogOfWarManager : MonoBehaviour
{
    ...
    [SerializeField]
    private ComputeShaderScriptableObject m_ComputeShadersObject;
    [SerializeField]
    ...
    private void Initialize()
    {
        ...
        m_FogOfWarComputeHandler = new FogOfWarComputeHandler(m_ComputeShadersObject.m_FogOfWarComputeShader, m_Resolution, m_ResolutionHeight, m_MapWidth, m_MapHeight, transform.position, m_VisionBlockingRenderTexture);
        m_UpscaleFogOfWarHandler = new UpscaleFogComputeHandler(m_ComputeShadersObject.m_UpscaleComputeShader, m_Resolution, m_ResolutionHeight);
        m_LerpComputeShaderHandler = new LerpTextureComputeHandler(m_ComputeShadersObject.m_LerpComputeShader, m_Resolution * 4, m_ResolutionHeight * 4, m_FogAppearSpeed, m_VisionDissapear);
        m_FogOfWarCheckComputeHandler = new FogOfWarCheckComputeHandler(m_ComputeShadersObject.m_FogOfWarCheckComputeShader);
